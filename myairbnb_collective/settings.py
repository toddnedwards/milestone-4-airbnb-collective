"""
Django settings for myairbnb_collective project.
...
ALLOWED_HOSTS = ['my-airbnb-collective-57b00b515cab.herokuapp.com',
                 'localhost', '8000-toddnedward-milestone4a-24mf4cn2l2p.ws.codeinstitute-ide.net']
...
LOGIN_REDIRECT_URL = '/properties/properties/'
...
print('WEBHOOK SECRET', STRIPE_WH_SECRET)

if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'info@myairbnbcollective.com'
else:
