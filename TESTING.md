...
|                   | If user has booked under 10 days for one booking for one property, the toast message will display that if the user books the remaining days, they'll receive the discount. | [Toast Message More Days Discount Message](readme_testing_media/full_testing/add_to_cart_success_message.png) | Pass |
| **Cart Page** |
