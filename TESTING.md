...
| Add Property | User should be able to see clearly which form provides what information to the user | Logged in and clicked add property link. Viewed page. | Add property clearly shows all fields, and inherits custom placeholers from .forms for further admin clarification |[Add property forms](readme_testing_media/full_testing/add_property_form.png) | Pass |
